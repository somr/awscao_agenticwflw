...
| [RUN_REPORT.md](RUN_REPORT.md) | Misplaced usage guide; starts with packaging instructions for files already present. Omits supported connection options. | Move to `docs/operations/run-report.md`; replace “Place” instructions with setup steps and document server URL, authentication, timeout and output options. |
